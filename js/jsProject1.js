document.addEventListener("DOMContentLoaded", () => {
  ...
  explanation.forEach(explanation => {
    explanation.addEventListener("mouseenter", () => {
      explanation.style.transform = "translateY(-4px)";
      explanation.style.boxShadow = "0 12px 32px rgba(0,0,0,0.2)";
    });

    explanation.addEventListener("mouseleave", () => {
      explanation.style.transform = "translateY(0)";
      explanation.style.boxShadow = "0 8px 32px rgba(0,0,0,0.1)";
    });
  });
  ...
  imgs.forEach(imgs => {
    imgs.addEventListener("mouseenter", () => {
      imgs.style.transform = "translateY(-4px)";
      imgs.style.boxShadow = "0 12px 32px rgba(0,0,0,0.2)";
    });

    imgs.addEventListener("mouseleave", () => {
      imgs.style.transform = "translateY(0)";
      imgs.style.boxShadow = "0 8px 32px rgba(0,0,0,0.1)";
    });
  });
  ...
  const titles = document.querySelectorAll(".titleExplanation");
